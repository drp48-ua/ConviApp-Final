<%@ Page Title="Política de Privacidad" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    ...
    <asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        <div class="glass-card" style="max-width:800px; margin:0 auto; padding:3rem;">
            <h1 style="margin-top:0;">🔒 Política de Privacidad</h1>
            <p style="color:var(--text-muted);">Última actualización: Abril 2026</p>
            <h3>1. Responsable del tratamiento</h3>
            <p>ConviApp HADA es un proyecto académico desarrollado por el Grupo H2640. El responsable del tratamiento de
            ...
            <p>Puedes acceder, rectificar o suprimir tus datos en cualquier momento desde tu perfil o contactándonos en
