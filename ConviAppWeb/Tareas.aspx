<%@ Page Title="Tareas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="Tareas.aspx.cs"
    ...
    <asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <% if (Session["UserRole"]==null || Session["UserRole"].ToString()=="Basico" ) { 
               ...
               var _ad = _cadAd.LeerPorSeccion("Tareas") ?? new ConviAppWeb.Models.ENAnuncio { Titulo = "Limpieza a Domicilio", Subtitulo = "-10% en tu primer servicio.", ImagenUrl = "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=400&h=300&fit=crop" };
        %>
                ...
                <asp:Panel ID="pnlApp" runat="server">
                    ...
                    <div class="glass-card" style="margin-bottom:24px;">
                        ...
                        <div style="display:flex; gap:12px; flex-wrap:wrap;">
                            ...
                            <asp:Button ID="btnAnadir" runat="server" Text="A&ntilde;adir" CssClass="btn btn-primary btn-sm"
